...
Pada hakikatnya, \textit{computer vision{ mencoba meniru cara kerja sistem visual manusia \textit{(Human Vision)}\citep{IJAIR42}. Manusia melihat objek dengan indra penglihatan (mata), lalu citra objek diteruskan ke otak untuk diinterpretasi sehingga manusia mengerti objek apa yang tampak dalam pandangan matanya.
